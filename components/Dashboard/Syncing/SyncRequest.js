...
const SyncRequest = ({requestType, setRequestType, sendAll, setSendAll, setSendRequest}) => {
    ...
    const components = [
        ...
        <SqillButton key="submit-button" text="Send Request" onClick={() => {setSendRequest(true)}} color="white" size="xs" background="gradient" >
...
export { SyncRequest, ChooseCreators, TypeChanger, SyncSecondContainer, Calendar, TextInput, TextArea }
